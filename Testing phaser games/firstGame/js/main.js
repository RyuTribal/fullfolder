...
var GameState = {
    ...
    create: function(){
        ...
        this.chicken.pixelPerfectClick = true;
        this.chicken.events.add(this.animateAnimal, this);*/
        ...
        this.rightArrow.events.onInputDown.add(this.switchAnimals, this);
        ...
        this.leftArrow.events.onInputDown.add(this.switchAnimals, this);
    ...
    switchAnimals: function(sprite, event){
        if(this.isMoving){
            return false;
        }
